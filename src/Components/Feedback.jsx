...
export default function Feedback() {
  ...
  const onSubmit = async (data) => {
    ...
    alert("Thanks for your amazing Message😜❤️!!!");
    setSpinner(false);
  };

  return (
    <div className="flex flex-col items-center justify-center gap-4">
      <h1 className="text-white italic text-[17px]">
      ...
      >
        <div className="mb-6 flex flex-col items-center gap-3">
          <p className="text-[13px] italic">Please Enter your message</p>
          <textarea
            ...
            className="text-[12px] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-28"
          ></textarea>
        </div>
